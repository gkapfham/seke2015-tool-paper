...
\title{\vspace*{-.6in}AERATE - A tool for Automated EmpRical
AsymTotic Evalution\vspace*{-.1in}}
...
\begin{abstract}
% Do we even need this? I don't know
\end{abstract}

%TODO cite the main paper (somewhere)
\section{Basic Introduction to Doubling}
...
\section{Description of Tool}
  ...
  time needed, all the while providing further assurance that a small ratio is not due to an insufficiently small $n$.
    ...
    \begin{figure}[h!]
    \lstinputlisting[basicstyle=\tiny]{content/QuickSortTrimmed.java}
